                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <div class="user-info ps-3">
                            <p class="user-name mb-0">Phạm Thành Đạt</p>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="javascript:;"><i class="fa-solid fa-right-from-bracket"></i><span>Đăng xuất</span></a>
                        </li>
                        <li><a class="dropdown-item" href="javascript:;"><i class="fa-solid fa-right-from-bracket"></i><span>Đăng xuất tất cả</span></a>
                        </li>
                        <li>
