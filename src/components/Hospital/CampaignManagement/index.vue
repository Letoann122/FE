        ...
        <div class="row g-4">
            <div class="col-lg-3">
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <!-- BUTTON FILTER -->
                            <div class="col-12">
                                <button class="btn btn-danger w-100 btn-sm" @click="applyFilter">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h6 class="card-title mb-3"><i class="bi bi-graph-up me-2"></i>Thống kê nhanh</h6>
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" @submit.prevent="createCampaign">
                            <div class="col-md-6">
                                ...
                                <input v-model="form.title" type="text" class="form-control" placeholder="Nhập tên chiến dịch" />
                            </div>
                            ...
                            <div v-if="form.locate_type === 'custom'" class="col-12">
                                ...
                                <input v-model="form.location" type="text" class="form-control" placeholder="Nhập địa điểm tổ chức" />
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea v-model="form.content" rows="3" class="form-control" placeholder="Nhập mô tả"></textarea>
                            </div>

                            <div class="col-12 text-end">
                                <button class="btn btn-danger">Tạo chiến dịch mới</button>
                            </div>
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <tr v-for="item in campaigns" :key="item.id">
                                        ...
                                        <td>
                                            <span v-if="item.status === 'ended'" class="badge bg-secondary">
                                                Đã kết thúc
                                            </span>

                                            <span v-else-if="item.status === 'running'" class="badge bg-success">
                                                Đang diễn ra
                                            </span>
                                        ...
                                        <td>
                                            <router-link :to="`/Hospital/campaigns/${item.id}`"
...
export default {
    ...
    methods: {
            ...
            baseRequestDoctor
                ...
                .then((res) => {
                    if (res.data.status) {
                        ...
                        // 💥 TÍNH TỔNG ĐĂNG KÝ TỪ registration_count
        ...
        createCampaign() {
            ...
            if (end < start) {
                this.$toast.error("Ngày kết thúc phải lớn hơn hoặc bằng ngày bắt đầu!");
                return;
            }

            if (end < today) {
                this.$toast.error("Ngày kết thúc không được nhỏ hơn hôm nay!");
                return;
            }
        ...
        formatRange(s, e) {
            if (!s || !e) return "-";
            return `${new Date(s).toLocaleDateString("vi-VN")} - ${new Date(
                e
