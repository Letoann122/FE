<template>
    <div class="blood-batch-detail-wrapper">
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Quản lý kho máu</a></li>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <span class="badge status-badge status-ok me-3"><i class="bi bi-check-circle-fill me-2"></i>Còn hạn sử dụng</span>
...
.icon-danger { background-color: #fde2e2; color: #c81e1e; }
