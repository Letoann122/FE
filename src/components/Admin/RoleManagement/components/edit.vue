  ...
  <div v-if="show" class="modal show d-block" style="background-color: rgba(0,0,0,0.5);" tabindex="-1">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form @submit.prevent="$emit('update-role')">
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <label class="form-label">Tên vai trò *</label>
                  <input v-model="roleData.name" type="text" required class="form-control">
                </div>
              </div>
              <div class="col-md-6">
                <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea v-model="roleData.description" class="form-control" rows="3"></textarea>
            </div>
            <div class="mb-3">
              <label class="form-label">Trạng thái</label>
              <select v-model="roleData.status" class="form-select">
                ...
                <div class="col-md-6">
                  <div v-for="(permission, index) in availablePermissions.slice(0, Math.ceil(availablePermissions.length / 2))" 
                    ...
                    <input v-model="roleData.permissions" :value="permission.name" type="checkbox" 
                           class="form-check-input custom-checkbox" :id="'edit-permission-' + permission.id">
